...
export const InfoSectionFull = forwardRef<HTMLDivElement>((_props, ref) => {
  return (
    <div
      ref={ref}
      className="relative bg-gray-200 font-sans flex flex-col items-center justify-center pt-24"
    >
      <div className="w-full max-w-5xl mx-auto text-center">
        <div className="mb-12">
          <h2 className="inline-block border-2 border-black px-10 py-3 text-3xl font-semibold tracking-widest">
            ABOUT ME
          </h2>
        </div>

        <p className="text-xl md:text-3xl text-gray-700 max-w-2xl mx-auto mb-18">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-12 text-left mb-16">
          <div className="flex flex-col items-start max-w-sm">
            <h3 className="text-2xl font-bold mb-2 tracking-wider">DESIGN</h3>
